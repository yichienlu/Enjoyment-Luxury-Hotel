  ...
  return (
    <>
      ...
      <section id="banner" className="h-[100vh] relative">
        ...
        >
          <SwiperSlide>
            <div className="h-full bg-[url('https://images.unsplash.com/photo-1559599238-308793637427')] bg-cover bg-center"></div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="h-full bg-[url('https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af')] bg-cover bg-center"></div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="h-full bg-[url('https://images.unsplash.com/photo-1560448205-4d9b3e6bb6db')] bg-cover bg-center"></div>
          </SwiperSlide>
        </Swiper>

        <div className="absolute inset-0 bg-[rgba(0,0,0,0.6)] px-5 lg:px-20 z-20">
          <div className="flex flex-col lg:flex-row z-20 h-full justify-center items-center pt-20 pb-10">
            <div className="lg:grow lg:shrink text-primary-100 font-bold lg:mb-0 ">
              <h2 className="text-[40px] mb-2 text-center lg:text-left">
                享樂酒店
              </h2>
            ...
            <div className="ml-20 md:ml-30 2xl:ml-50 text-white py-15 lg:py-24 2xl:px-16 bg-[linear-gradient(180deg,#FFF0_0%,#FFF5_100%)] backdrop-blur-md border-t border-r border-white border-solid rounded-[40px] lg:rounded-[80px] relative">
              <h3 className="text-5xl lg:text-6xl 2xl:text-[100px] leading-tight font-bold mb-6 -translate-x-16 2xl:-translate-x-30">
                高雄
                <br />
                豪華住宿之選
              </h3>
              <p className="mb-10 lg:mb-15 lg:text-xl 2xl:text-[32px] lg:whitespace-nowrap tracking-widest -translate-x-16 2xl:-translate-x-30">
                我們致力於為您提供無與倫比的奢華體驗與優質服務
              </p>
              <button className="w-full p-5 lg:p-8 2xl:p-10 bg-white hover:bg-primary-100 text-black hover:text-white text-2xl font-bold rounded-lg -translate-x-16 2xl:-translate-x-30 duration-200">
                立即訂房
              </button>
            </div>
          </div>
        ...
        <div className="container lg:flex ">
          ...
          <div className="text-black">
            <a href="#" className="block lg:flex items-center mb-10 group duration-200" >
              ...
              <div>
                <h3 className="font-bold text-[28px] group-hover:text-primary-100 duration-200">
                  秋季旅遊，豪華享受方案
                </h3>
                <p className="text-sm">
        ...
        <div className="bg-light px-5 lg:px-20 py-20 lg:py-30  overflow-x-hidden">
          <div className="container">
            <div className="flex items-center mb-10 lg:mb-20">
              <h2 className="text-primary-100 text-[32px] lg:text-[48px] tracking-[2.4px] font-bold">
                佳餚
                <br />
                美饌
              </h2>
